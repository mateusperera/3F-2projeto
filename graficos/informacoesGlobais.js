...
async function visualizaDadosGlobais(){
    ...
    paragrafo.innerHTML = `No mundo tem <span> ${totalPessoasMundo} bilhoes </span> de 
    habitantes, dos quais <span> ${totalPessoasConectadas} bilhoes </span> estao conectadas em alguma 
    rede social por um tempo medio de <span> ${tempoMedio} horas</span>.`
